...
import { refs, peerVideoTrack } from '../rtc/refs.ts';
import { setWatching, peerVolume, setPeerVolume } from '../rtc/room.ts';
import { Avatar } from './Avatar.tsx';
import { registerBox, unregisterBox } from '../util/colorLoop.ts';
import { requestView } from '../rtc/viewerControl.ts';
